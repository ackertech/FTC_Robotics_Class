...
public class RoadKill_Campbell extends FourMoterDrive_Campbell {
    ...
    public void initRobot (HardwareMap hwMap) {
        ...
        //Using Method form Drive train Class to set the motor run modes
